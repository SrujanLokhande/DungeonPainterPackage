...
namespace Srujan.DungeonGenerator.Runtime
{
    public class DungeonGenerator : MonoBehaviour
    {
        ...
        public void AddRoom()
        {
            ...
            // if we already have a room the next room center will the first rooms centre
        ...
        public void GenerateAll()
        {
            ...
            if(_seed ==0) Random.InitState(Random.Range(0, int.MaxValue));
            ...
            foreach(Bounds room in Rooms)
            {
                ...
                for(int x = 0; x < tileCountX; x++)
                {
                    for (int z = 0; z < tileCountY; z++)
                    {
                        ...
                        // extra check for walls/stairs/doors
                        else
                        {
